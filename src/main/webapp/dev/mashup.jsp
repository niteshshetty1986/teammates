...
<html>
    <head>
        ...
        <script type="text/javascript" src="<%= FrontEndLibrary.BOOTSTRAP_CSS.getScriptSource() %>"></script>
        <script type="text/javascript" src="<%= FrontEndLibrary.BOOTSTRAP_THEME_CSS.getScriptSource() %>"></script>
